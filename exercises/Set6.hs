...
simplify (RationalNumber n d) =
  RationalNumber (n `div` gcd n d) (d `div` gcd n d)
...
instance Num RationalNumber where
  (RationalNumber x y) + (RationalNumber a b) =
    simplify $ RationalNumber (b * x + a * y) (y * b)
  (RationalNumber x y) * (RationalNumber a b) =
    simplify $ RationalNumber (x * a) (y * b)
  abs (RationalNumber x y) = simplify $ RationalNumber (abs x) (abs y)
  signum (RationalNumber x y) =
    simplify $ RationalNumber (signum x * signum y) 1
  fromInteger x = simplify $ RationalNumber x 1
  negate (RationalNumber x y) = simplify $ RationalNumber (x * (-1)) y
